...
const ScaleDetail = () => {
  ...
  const advancedIds = new Set(["sofa", "cam-icu", "news2", "cha2ds2-vasc", "wells-pe", "must", "phq9", "waterlow"]);
  const isAdvancedAssessment = Boolean(id && advancedIds.has(id));
